...
```{r}
modeldata=load_data('ISI', 'loss','POP1')
```
...
filename = "POP1_robmodel_loss_ISI"
title = "Experiment 1a: Predicting spin iniitation latency after a loss"
pcol="p value"

apa_table(data,filename='test',pcol=pcol,title=title,column_header=names(data))
```
...
write.table(tail(robustmodelrev,6),"POP1_robust_model_gp_rev.csv",sep=",")
...
filename = "POP1_robmodel_loss_ISI_gp_rev"
title = "Experiment 1a: Predicting spin iniitation latency after a loss: group reversed"
pcol="p value"
...
write.table(tail(robustmodeloutlier,6),"POP1_robust_model_outlier_removal.csv",sep=",")
...
filename = "POP1_robmodel_loss_ISI_outlier_removal"
title = "Experiment 1a: Predicting spin iniitation latency after a loss: prereg outlier removal"
pcol="p value"
